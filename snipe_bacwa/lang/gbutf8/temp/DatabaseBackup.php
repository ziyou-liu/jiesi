...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
    <td width="51%">位置：备份数据 -&gt; 选择数据库(<b>';echo $mydbname;echo '</b>) -&gt; <a href="ChangeTable.php?mydbname=';echo $mydbname;echo '">选择备份表</a></td>
...
<form name="ebakchangetb" method="post" action="DatabaseBackupDo.php" onsubmit="return check();">
...
;echo '          <tr bgcolor="#DBEAF5"> 
    ...
    <tr> 
      <td height="25">
<div align="center">
          <input type="submit" name="Submit" value="开始备份" onclick="document.ebakchangetb.phome.value=\'DoEbak\';document.ebakchangetb.action=\'DatabaseBackupDo.php\';">
          &nbsp;&nbsp; &nbsp;&nbsp;
		</div></td>
    </tr>
  </table>
