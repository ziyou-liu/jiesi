...
if ($hyid!=$_SESSION["glo_username"]){
$tjupstr="";
gethytjupstr($hyid,$tjupstr);
...
;echo '	  <TD align="center" valign="middle" bgColor="';echo $bgcol;;echo '" width="60"><font color="#FFFFFF">';echo $value;echo '</font></TD>	  
	...
	<table width="100%" border="0">
	  ...
	  <td height="30" align="center">搜索期数：<input name="periods1" type="text" id="periods" style="width:100px;">
					<input type="submit" name="btnSearch" value="搜索" id="btnSearch" class="button_text" onMouseOver="this.className=\'button_onmouseover\'" onMouseDown="this.className=\'button_onmousedown\'" onMouseOut="this.className=\'button_onMouseOut\'">(若不添加期数系统默认为第';echo $c_periods;;echo '期，当前查询第';echo $periods;;echo '期)</td>
		</form>
		</tr>
	</table>
<!-- 拓扑图开始 -->
...
;echo '          <tr>
            <td height="20" align="center" bgcolor="';echo $bg1;;echo '"><a style="WIDTH: 100px; BACKGROUND-COLOR:';echo rankcolor($hyrank);echo '" href="?userid=';echo urlencode($rs11["username"]);echo '&periods=';echo $periods;;echo '&periods1=';echo $periods1;;echo '&psearch=';echo $psearch;;echo '"><font color="ffffff"><strong>';echo $rs11["username"];echo '</strong></font></a></td>
          </tr>
		 <!-- <tr>
...
if($rs11["director"]==1){
;echo '           <tr>
            <td height="20" align="center" bgcolor="#E7F2FB"><table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#517DBF">
		  <tr bgcolor="#ffffff">
            <td>&nbsp;</td>
            <td>报单</td>
			<td>消费</td>
