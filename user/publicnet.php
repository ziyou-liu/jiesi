...
$sqlh="select id from {$db_prefix}bwnet where username='".$_SESSION["glo_username"]."' and state=1 order by id asc limit 1";
$rsh=$db->get_one($sqlh);
$hyid=$rsh["id"];
if (!empty($_GET['userid'])){
$sqlhy="select id from {$db_prefix}bwnet where username='".$_GET['userid']."' and state=1 order by id asc limit 1";
