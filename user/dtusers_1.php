...
<script language="javascript" src="js/transfer.js"></script></head>
...
if(empty($periods)) $timelimit=$timelimit1=$timelimit2=time();
...
if($pos==1) return $result["leftsy"];elseif($pos==2) return $result["rightsy"];else return $result["c_sy"];
}
