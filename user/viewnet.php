...
if(empty($periods)) echo "Please add periods first!";
  ...
  <table width="100" border="0" cellpadding="0" cellspacing="1" bgcolor="#517DBF" align="center">
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="1" cellpadding="0">
		  ...
		  <!--
          <tr>
            <td height="20" align="center" bgcolor="#1956A6" colspan="3"><font color="ffffff">';echo $rs11["realname"];echo '</font></td>
          </tr>
		  -->
          <tr>
...
global $db;global $db_prefix,$hytjnetznum,$hytjnetznum1,$timelimit,$timelimit2;
if ($dtp1<=$dtp){
